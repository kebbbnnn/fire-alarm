 ...
 */
public class WhatToDoDialog extends DialogFragment {

  public static WhatToDoDialog create(boolean darkTheme, int accentColor) {
    WhatToDoDialog dialog = new WhatToDoDialog();
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    try {
      ...
      InputStream json = getActivity().getAssets().open("whattodo.html");
